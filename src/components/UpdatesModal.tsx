...
import { 
  X, Plus, Image as ImageIcon, Type,
  Sparkles, ChevronRight, ChevronDown, RefreshCw, Search,
  MoreVertical, Shield, Archive, EyeOff, Eye, CheckCircle
} from 'lucide-react';
...
export const UpdatesModal: React.FC<UpdatesModalProps> = ({
  ...
  const fetchStories = async () => {
    ...
    try {
      ...
      console.error('Failed to fetch stories in modal:', err);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    ...
    >
      <div 
        id="updates-modal-container"
        className="relative w-full h-full sm:h-[90vh] sm:max-h-[720px] sm:max-w-lg bg-[#17212b] text-white sm:rounded-2xl shadow-2xl flex flex-col overflow-hidden border-0 sm:border sm:border-[#242f3d]"
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-3.5 bg-[#242f3d] border-b border-[#101921] shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-semibold text-white leading-tight">Pembaruan</h2>
              <p className="text-[11px] text-[#7f91a4]">Pembaruan Status & Cerita (24 Jam)</p>
            </div>
          </div>
          <div className="flex items-center gap-1.5">
            ...
            <div className="relative">
              <button
                id="btn-updates-modal-more-menu"
                type="button"
                onClick={() => setIsMenuOpen(prev => !prev)}
                className={`p-2 rounded-full text-[#7f91a4] hover:text-white hover:bg-[#17212b] transition-colors cursor-pointer ${
                  isMenuOpen ? 'text-white bg-[#17212b]' : ''
                }`}
                title="Opsi Status"
              >
              ...
              {isMenuOpen && (
                <>
                  ...
                  />
                  <div 
                    id="updates-modal-dropdown-menu"
        ...
        {/* Search Bar */}
        <div className="p-3 bg-[#1c2734] border-b border-[#242f3d] shrink-0">
          <div className="relative">
            <input
              type="text"
              placeholder="Cari pembaruan kontak..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full bg-[#242f3d] border border-[#242f3d] focus:border-[#5288c1] rounded-xl py-2 pl-3.5 pr-9 text-xs focus:outline-hidden text-white placeholder-[#7f91a4]"
            />
            {searchQuery ? (
              <button
          ...
          <div className="bg-[#202b36] rounded-2xl p-4 border border-[#2b394a]">
            <div className="flex items-center justify-between">
                ...
                <div>
                  ...
                  <div className="text-xs text-[#7f91a4] mt-0.5">
                    {myStories.length > 0 
                      ...
                      : 'Ketuk untuk membagikan foto, teks berwarna, atau suara'}
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className="px-3.5 py-2 bg-[#5288c1] hover:bg-[#4374a8] text-white text-xs font-bold rounded-xl flex items-center gap-1.5 cursor-pointer transition-all shadow-md shadow-[#5288c1]/20"
              >
              ...
              {filteredActiveContacts.length === 0 ? (
                <div className="p-8 text-center bg-[#202b36]/30 border border-[#242f3d] rounded-2xl flex flex-col items-center justify-center">
                  ...
                  <p className="text-xs text-[#7f91a4] mt-1 max-w-xs leading-relaxed">
                    Status foto atau teks berwarna dari kontak Anda akan muncul di sini secara langsung.
                  </p>
                </div>
              ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        ...
                        <ChevronRight className="w-4 h-4 text-[#7f91a4] group-hover:text-white transition-colors shrink-0" />
                      </div>
                    </div>
                  );
                })
